...
All 18 Capitals have unique painterly environment illustrations built for their name, faction, and strategic identity. The 588 deck-building cards use deterministic illustrations combining faction environments, card type, name-derived symbols, mechanics, and stable seeded composition; new cards automatically receive artwork as they are added. Missing painted resources safely fall back to the procedural renderer. See [the card-art system](docs/card-art-system.md) for its visual vocabulary and asset provenance.
