...
final class CardArtFactory {
    ...
    private static Color faction(String f){return switch(f.toUpperCase(Locale.ROOT)){case"ARES"->new Color(193,61,55);case"ATHENA"->new Color(85,128,177);case"HADES"->new Color(111,70,143);case"HEPHAESTUS"->new Color(191,103,45);case"POSEIDON"->new Color(32,137,171);case"ZEUS"->new Color(178,154,63);default->new Color(93,110,130);};}
    private static Color highlight(String f){return switch(f.toUpperCase(Locale.ROOT)){case"ARES"->new Color(255,185,101);case"ATHENA"->new Color(207,228,255);case"HADES"->new Color(165,255,191);case"HEPHAESTUS"->new Color(255,208,92);case"POSEIDON"->new Color(139,246,255);case"ZEUS"->new Color(255,239,157);default->new Color(224,234,245);};}
