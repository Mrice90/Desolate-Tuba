...
- Player 1 receives 4 GP on their first personal turn and one extra opening card as prototype second-player advantages, then follows normal GP growth.
- Empty-deck draws deal one exhaustion damage to each controlled Permanent.
- Conquest Pressure deals 3 damage to each active player's Permanent at the start of turns 11–16, then 4 damage from turn 17 onward. From turns 11–22, each player receives exactly six pressure pulses.
