...
The Spell art rollout now covers all 10 Zeus Spells: five core tactical effects and their five apex-scale counterparts. The Land rollout covers all 10 Zeus Lands, from the modest Dawncloud Step foothold through the apex Celestial Throne Grid. Zeus Structures are the faction's final scheduled category.
