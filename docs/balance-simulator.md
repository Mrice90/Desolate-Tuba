...
Current prototype targets are approximately 15 total turns for an average match and 22 turns for a long match. Player 1 (the second player in turn order) receives 3 GP on their first personal turn and a sixth opening card to counter first-player tempo. Conquest Pressure begins on turn 11 and escalates on turn 17; this gives each player six pressure pulses by the turn-22 deadline, which resolves remaining matches by Permanent count and then remaining Permanent HP.
